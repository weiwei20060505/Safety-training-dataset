...
# Use the old cache that was likely used to generate the V1 plot
v1_cache = r"C:\Users\weiwe\Safety-training-dataset\Safety-training-dataset\results\v1_baseline\old\safety_guardrails_evaluation\without_pca\cache\calibrated_predictions.pkl"
...
print("--- V1 Data (from old results cache) ---")
